# Debian Zsh 配置与标签显示脚本

一个为Debian延伸版设计的Zsh配置脚本，提供现代化终端体验和自定义标签显示功能。
...
## 📝 安装说明
- 该脚本需要sudo权限运行
- **默认：Root 保持 Bash，不配置 Zsh**
- **可选**：如需为 Root 启用 Zsh，请取消第 37、72 行的注释
  ```bash
  # 第37行：sudo chsh -s $(which zsh) root
  # 第72行：write_zshrc "/root" "true"